...
import (
	...
	"github.com/LumoraProject/go-lumora/crypto/signify"
	"github.com/LumoraProject/go-lumora/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	...
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/LumoraProject/go-lumora/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/LumoraProject/go-lumora/internal/version.gitDate="+env.Date)
	}
...
func doCheckBadDeps() {
	baddeps := [][2]string{
		...
		{"github.com/LumoraProject/go-lumora/core/rawdb", "github.com/LumoraProject/go-lumora/ethdb/leveldb"},
		{"github.com/LumoraProject/go-lumora/core/rawdb", "github.com/LumoraProject/go-lumora/ethdb/pebbledb"},
	}
	tc := new(build.GoToolchain)
